...
class Runner(object):
    def __init__(self, config):
        ...
        for agent_id in range(self.num_agents):
            ...
            obs_shape = self.envs.observation_space[agent_id].shape[-1:]           
            share_obs_shape = share_observation_space.shape[-1:]                   
            print(f"[DEBUG BUFFER] obs_shape init (agent {agent_id}): {obs_shape}")
